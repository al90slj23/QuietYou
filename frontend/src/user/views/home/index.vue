<template>
  <div class="home-page">
    ...
    <div class="header-area">
      ...
      <div class="search-box" @click="router.push('/service/list')">
    ...
    <div class="section">
      <div class="section-head">
        <h3>精选推荐</h3>
        <span class="see-all" @click="router.push('/service/list')">查看全部</span>
      </div>
    ...
    <div class="section">
      <div class="section-head">
        <h3>优选技师</h3>
        <span class="see-all" @click="router.push('/technician/list')">查看全部</span>
      </div>
      <div class="tech-list">
        <div 
          class="tech-item"
...
const goToService = (id) => {
  router.push({ path: '/service/list', query: { categoryId: id } })
}
</script>
